...
(e.g. `cachito-js-proxy`) that points to the npm/yarn registry (registry.npmjs.org, registry.yarnpkg.com).
The hosted repository will contain all non-registry dependencies and the proxy repository will contain
